  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Obx(
          () => Skeletonizer(
            enabled: controller.isloadDetail.value,
            child: Column(
              ...
              children: [
                ...
                Container(
                  child: Padding(
                    ...
                    child: Text(
                      controller.detail.value?.name ?? "House Name",
                      style: TextStyle(
                        fontSize: 24,
                        fontWeight: FontWeight.bold,
                      ),
                ...
                Container(
                  child: Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 24),
                    child: Text(
                      controller.detail.value?.location ?? "Location",
                      style: TextStyle(
                        fontSize: 14,
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 3),
                            Text(
                             controller.detail.value?.landArea.toString() ?? "0 m2",
                              style: TextStyle(
                                fontSize: 12,
                                color: AppColors.primary,
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 3),
                            Text(
                             controller.detail.value?.bedrooms.toString() ?? "0",
                              style: TextStyle(
                                fontSize: 12,
                                color: AppColors.primary,
                                fontWeight: FontWeight.w400,
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 3),
                            Text(
                              controller.detail.value?.buildingArea.toString() ?? "0 m2",
                              style: TextStyle(
                                fontSize: 12,
                                color: AppColors.primary,
                                fontWeight: FontWeight.w400,
                ...
                Container(
                  margin: EdgeInsets.symmetric(horizontal: 24),
                  child: Text(
                   CurrencyConverter.formatRupiah(int.parse(controller.detail.value?.price ?? "0")),
                    style: TextStyle(
                      fontSize: 20,
                      fontWeight: FontWeight.bold,
                      color: AppColors.primary,
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            controller.navigateToPropertyList();
                          },
                          style: ElevatedButton.styleFrom(
                            backgroundColor: Colors.white,
                            shape: RoundedRectangleBorder(
